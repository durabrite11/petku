    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-auto">
                        <a href="bank/create" class="btn btn-primary btn-sm mr-3"><i class="fa fa-plus"></i> Tambah</a>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('bank.destroy', $model->id) }}" method="post">
                                    @method("delete")
                                    @csrf
                                    <a href='{{ URL::to("admin/bank/$model->id/activate")}}' class="btn btn-default btn-sm mb-2"><i
                                            class="fa fa-solid fa-check"></i>
                                        Aktif/Non Aktif</a><br>
                                    <a href='{{ URL::to("admin/bank/$model->id/edit")}}' class="btn btn-warning btn-sm"><i
